...
def main():
    ...
    model = load_model(args.model_path, device, original_model=False)
    ...
    embd_dataset = CapstoneDataset(args.dataset_path,
                                   args.image_path,
                                   ds_type="full",
    ...
    with torch.no_grad():
        for i, (images, labels) in enumerate(embd_dataloader):
